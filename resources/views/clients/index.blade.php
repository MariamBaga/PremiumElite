...
<div class="card">
  <div class="card-body">
    ...
    <form method="GET" class="row g-2 mb-3">
      ...
      <div class="col-md-3">
        <input name="localisation" class="form-control" placeholder="Localisation" value="{{ request('localisation') }}">
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-hover align-middle">
        ...
        <tbody>
          ...
          @empty
            <tr><td colspan="11" class="text-center text-muted">Aucun client</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
